...
| SourcePath | cfg.SourcePath = val; break; | reference | src/_reference/uncompiled/EJLive.Core/Models/TransactionModels.cs |
| backupJournalPath | config.BackupJournalPath = value; break; | reference | src/_reference/uncompiled/EJLive.Core/Config/AgentConfiguration.cs |
| imageDestinationPath | config.ImageDestinationPath = value; break; | reference | src/_reference/uncompiled/EJLive.Core/Config/AgentConfiguration.cs |
| imageInboxPath | config.ImageInboxPath = value; break; | reference | src/_reference/uncompiled/EJLive.Core/Config/AgentConfiguration.cs |
| serverPort | if (int.TryParse(value | reference | src/_reference/uncompiled/EJLive.Core/Config/AgentConfiguration.cs |
| sourceJournalPath | config.SourceJournalPath = value; break; | reference | src/_reference/uncompiled/EJLive.Core/Config/AgentConfiguration.cs |
