...
|---|---|---|---|
| Projects / assemblies (14) | "all .NET projects, class hierarchies, namespaces" | `EJLive.Platform.slnx`, `artifacts/ProjectDependencyGraph.md` | exists — 29 csproj collapsed to 14, acyclic, L0–L5 |
