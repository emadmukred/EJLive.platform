...
- **Ledgers are the authority.** Numbers quoted anywhere (`303/57 551` compiled,
  ...
  38 gate rules) come from `artifacts/InventorySummary.json` + `docs/inventory/*`, regenerated in the
