...
internal sealed class InstallerOperationalSecurityOptions
{
...
internal sealed class InstallerOperationalSecurityResult
{
...
/// </summary>
internal static class InstallerOperationalSecurityService
{
    ...
    private const string PreviousFirewallInboundRuleName = "EJLive Client Socket Inbound 5656";
    private const string PreviousFirewallOutboundRuleName = "EJLive Client Socket Outbound 5656";
    ...
    private static void RunFirewallRuleApply(int port, string remoteAddresses, InstallerOperationalSecurityResult result)
    {
        ...
        DeleteFirewallRule(PreviousFirewallInboundRuleName, result, "Previous firewall inbound pre-clean");
        DeleteFirewallRule(PreviousFirewallOutboundRuleName, result, "Previous firewall outbound pre-clean");
    ...
    private static void RunFirewallRuleRemove(InstallerOperationalSecurityResult result)
    {
        ...
        DeleteFirewallRule(PreviousFirewallInboundRuleName, result, "Previous firewall inbound remove");
        DeleteFirewallRule(PreviousFirewallOutboundRuleName, result, "Previous firewall outbound remove");
    }
    ...
    private static void RemoveRegistryArtifacts(InstallerOperationalSecurityResult result)
    {
        ...
        RemoveRunValue(RegistryHive.LocalMachine, RegistryView.Registry64, LocalMachineRunKey, InstallerStartupManager.CompanionRunValueName, result, "HKLM Run companion value");
