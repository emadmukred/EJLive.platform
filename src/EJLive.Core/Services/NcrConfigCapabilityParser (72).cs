// NcrConfigCapabilityParser (72).cs
...
public sealed class NcrConfigCapabilityParser
{
...
public partial class NcrConfigCapabilityParser : (?<hex>[0-9a-fA-F]
{
    private void AddUnique(List<string> target, string value)
    {
        if (string.IsNullOrWhiteSpace(value))
...
public partial public sealed class NcrConfigCapabilityParser
{
    private static readonly Regex IncludeRegex = new Regex(@"<\?xml-include\s+(?<path>[^?]+)\?>", RegexOptions.Compiled | RegexOptions.IgnoreCase);
    private static readonly Regex FormNameRegex = new Regex(@"FormName\"\s+Value=\"(?<name>[^\"]+)\"", RegexOptions.Compiled | RegexOptions.IgnoreCase);
    private static readonly Regex PropertyRegex = new Regex(@"Property\s+Name=\"(?<name>[^\"]+)\"\s+Value=\"(?<value>[^\"]*)\"", RegexOptions.Compiled | RegexOptions.IgnoreCase);
    ...
    public NcrConfigCapabilityProfile Parse(IDictionary<string, string> files)
    {
        private void ParseAccfg(string content, NcrConfigCapabilityProfile profile)
        {
            private void ParseTerminalConfiguration(string content, NcrConfigCapabilityProfile profile)
            {
                ...
                public partial public public class NcrConfigCapabilityParser
                {
                    private static readonly Regex IncludeRegex = new Regex(@"<\?xml-include\s+(?<path>[^?]+)\?>", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                    private static readonly Regex FormNameRegex = new Regex(@"FormName""\s+Value=""(?<name>[^""]+)""", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                    private static readonly Regex PropertyRegex = new Regex(@"Property\s+Name=""(?<name>[^""]+)\"\s+Value=\"(?<value>[^\"]*)\"", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                    ...
                    private void AddUnique(List<string> target, string value)
                    {
                        public NcrConfigCapabilityProfile Parse(IDictionary<string, string> files)
                        {
                            private void ParseAccfg(string content, NcrConfigCapabilityProfile profile)
                            {
                                ...
                                public partial public class NcrConfigCapabilityParser
                                {
                                    private static readonly Regex IncludeRegex = new Regex(@"<\?xml-include\s+(?<path>[^?]+)\?>", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                                    private static readonly Regex FormNameRegex = new Regex(@"FormName""\s+Value=""(?<name>[^""]+)""", RegexOptions.Compiled | RegexOptions.IgnoreCase);
                                    private static readonly Regex PropertyRegex = new Regex(@"Property\s+Name=""(?<name>[^""]+)\"\s+Value=\"(?<value>[^\"]*)\"", RegexOptions.Compiled | RegexOptions.IgnoreCase);
...
public partial class NcrConfigCapabilityParser
{
    private void AddUnique(List<string> target, string value)
    {
        if (string.IsNullOrWhiteSpace(value))
...
// Class: NcrConfigCapabilityParser (from 7 sources)
public sealed partial class NcrConfigCapabilityParser : (?<hex>[0-9a-fA-F]
{
    // --- Properties ---
    private void AddUnique(List<string> target, string value)
    {
...
// Class: NcrConfigCapabilityParser (from 3 sources)
public partial class NcrConfigCapabilityParser
{
    // --- Properties ---
    private void AddUnique(List<string> target, string value)
...
// Class: NcrConfigCapabilityParser (from 2 sources)
public sealed partial class NcrConfigCapabilityParser
{
    // --- Properties ---
    private void AddUnique(List<string> target, string value)
    {
...
// Class: NcrConfigCapabilityParser (from 9 sources)
public sealed partial class NcrConfigCapabilityParser
{
    // --- Properties ---
    private void AddUnique(List<string> target, string value)
...
// Class: NcrConfigCapabilityParser (from 5 sources)
public sealed partial class NcrConfigCapabilityParser
{
    // --- Properties ---
    private void AddUnique(List<string> target, string value)
...
if (resetMatch.Success)
profile.ResetActionOnInitialise = Convert.ToInt32(resetMatch.Groups["hex"].Value, 16);
// Variant: d:\EJLIVE\EJlive_Reference_Projects\EJLive_38\EJLive.Unified\src\EJLive.Core\Services\NcrConfigCapabilityParser.cs
private void ParseRegistry(string content, NcrConfigCapabilityProfile profile)
{
    if (string.IsNullOrWhiteSpace(content))
    return;
...
if (resetMatch.Success)
profile.ResetActionOnInitialise = Convert.ToInt32(resetMatch.Groups["hex"].Value, 16);
// Variant from: d:\EJLIVE\EJlive_Reference_Projects\EJLive_Complete_Unified\src\EJLive.Core\Services\NcrConfigCapabilityParser.cs
private void ParseRegistry(string content, NcrConfigCapabilityProfile profile)
{
    if (string.IsNullOrWhiteSpace(content))
    return;
...
// Variant from: d:\EJLIVE\EJlive_Reference_Projects\CodexMarege\src\EJLive.Core\Services\NcrConfigCapabilityParser.cs
private void ParseRegistry(string content, NcrConfigCapabilityProfile profile)
{
    if (string.IsNullOrWhiteSpace(content))
    return;
