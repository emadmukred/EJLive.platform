...
{
    public sealed class JournalNetworkEngine : IDisposable
    {
        ...
        {
            var baseDelay = (int)_reconnectPolicy.ComputeDelay(attempt).TotalMilliseconds;
    ...
    public partial class NetworkTransportOptions
        {
            public bool EnableTlsTransport { get; set; }
    ...
    // Class: NetworkTransportOptions (from 2 sources)
        public sealed partial class NetworkTransportOptions
        {
            // --- Properties ---
            public bool EnableTlsTransport { get; set; }
