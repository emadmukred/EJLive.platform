...
{
    public partial class NetworkSessionManager : IDisposable
        {
    ...
    public partial public public sealed class NetworkSessionManager : IDisposable
        {
            private readonly string _serverHost;
            private readonly int _serverPort;
            private readonly string _atmId;
    ...
    public partial public sealed class NetworkSessionManager : IDisposable
        {
            private readonly string _serverHost;
            private readonly int _serverPort;
            private readonly string _atmId;
    ...
    // Class: NetworkSessionManager (from 4 sources)
        public sealed partial class NetworkSessionManager : IDisposable
        {
            // --- Constants & Fields ---
                    private readonly string _serverHost;
