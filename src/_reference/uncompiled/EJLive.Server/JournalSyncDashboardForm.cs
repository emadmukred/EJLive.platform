...
{
    public partial class JournalSyncDashboardForm : Form
    {
        ...
        public JournalSyncDashboardForm()
        {
            Text = "Journal Sync Dashboard";
            Size = new Size(900, 600);
            StartPosition = FormStartPosition.CenterParent;
            _grid = new DataGridView { Dock = DockStyle.Fill, AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill, AllowUserToAddRows = false, ReadOnly = true, RowHeadersVisible = false };
            Controls.Add(_grid);
